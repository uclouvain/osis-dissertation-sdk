...
class AdviserApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.advisers_list_endpoint = _Endpoint(
            settings={
                'response_type': (AdviserList,),
                'auth': [
                    'Token'
                ],
                'endpoint_path': '/advisers',
                'operation_id': 'advisers_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def advisers_list(
        ...
        **kwargs
        ...
        """advisers_list  # noqa: E501

        Return advisers list  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.advisers_list(async_req=True)
        >>> result = thread.get()
        ...
        return self.advisers_list_endpoint.call_with_http_info(**kwargs)
