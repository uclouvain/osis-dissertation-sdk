...
class DissertationLocationApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.dissertation_locations_list_endpoint = _Endpoint(
            settings={
                'response_type': (DissertationLocationList,),
                'auth': [
                    'Token'
                ],
                'endpoint_path': '/dissertation_locations',
                'operation_id': 'dissertation_locations_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def dissertation_locations_list(
        self,
        **kwargs
    ):
        """dissertation_locations_list  # noqa: E501

        Return all dissertation locations available  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.dissertation_locations_list(async_req=True)
        >>> result = thread.get()
        ...
        return self.dissertation_locations_list_endpoint.call_with_http_info(**kwargs)
